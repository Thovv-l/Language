        ...
        ZStack {
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    // Lesson info cards
                    HStack(spacing: 16) {
                        InfoCard(icon: "clock.fill", title: "\(lesson.estimatedMinutes) min", color: .blue)
                        InfoCard(icon: "star.fill", title: "+\(lesson.xpReward) XP", color: .yellow)
                        InfoCard(icon: "text.book.closed.fill", title: "\(lesson.exercises.count) exercises", color: .green)
                    }
